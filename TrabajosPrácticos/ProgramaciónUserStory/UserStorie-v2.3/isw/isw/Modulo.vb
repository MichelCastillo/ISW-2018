Module Modulo
    ...
    Public Sub guardar_pedido_tarjeta(ByVal dirC As String, ByVal dirE As String, ByRef det As String, ByVal fecha As String, ByVal hs As String, ByVal nroT As Long, ByVal tit As String, ByVal pinT As Integer, ByVal venc As String, ByVal img As Image)
