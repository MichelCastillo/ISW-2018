Public Class Pedidos
    ...
    Public Property nroTarjeta As Integer
    ...
    Public Sub set_pedidosT(ByVal dirC As String, ByVal dirE As String, ByRef det As String, ByVal fecha As String, ByVal hs As String, ByVal cos As Double, ByVal nroT As Integer, ByVal tit As String, ByVal pinT As Integer, ByVal venc As String, ByVal img As Image)
