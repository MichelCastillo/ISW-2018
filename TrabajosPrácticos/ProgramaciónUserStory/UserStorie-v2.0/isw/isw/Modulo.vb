Module Modulo
    ...
    Public Sub guardar_pedido_tarjeta(ByVal dirC As String, ByVal dirE As String, ByRef det As String, ByVal fecha As String, ByVal hs As String, ByVal cos As Double, ByVal nroT As Integer, ByVal tit As String, ByVal pinT As Integer, ByVal venc As String, ByVal img As Image)
        Dim nuevo_pedido As New Pedidos
        nuevo_pedido.set_pedidosT(dirC, dirE, det, fecha, hs, cos, nroT, tit, pinT, venc, img)
