Public Class Pedido
    ...
    Public Function validaciones() As Boolean
        ...
        If DateTimePicker1.Value.Month = Date.Now.Date.Month And DateTimePicker1.Value.Day = Date.Now.Date.Day Then
            If Date.Now.Date.Hour <= txtHora.Text Then
                MessageBox.Show("Error en fecha programada", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return True
            End If
        End If
