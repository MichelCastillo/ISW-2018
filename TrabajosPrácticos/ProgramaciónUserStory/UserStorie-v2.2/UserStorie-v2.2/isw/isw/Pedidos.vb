Public Class Pedidos
    ...
    Public Sub set_pedidosT(ByVal dirC As String, ByVal dirE As String, ByRef det As String, ByVal fecha As String, ByVal hs As String, ByVal nroT As Integer, ByVal tit As String, ByVal pinT As Integer, ByVal venc As String, ByVal img As Image)
